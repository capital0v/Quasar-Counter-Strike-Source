            ...
            { "92", new OffsetsData
                {
                    Client = new ClientOffsets
                    {
                        sv_showimpact = 0x588599,
                        weaponName = 0x4D4E64,
                        thirdperson = 0x5065AD,
                        thirdpersonAddress = 0x145220,
                        thirdpersonAddressBytes = new byte[] { 0xC6, 0x81, 0x8D, 0x00, 0x00, 0x00, 0x00 },
                        r_drawothermodels = 0x4C4BA1,
                        r_drawparticles = 0x4F7A41,
                        r_drawrenderhitboxes = 0x4C5FA1,
                        cl_bob = 0x50C869,
                        dwEntityList = 0x4D5AE4
                    },
                    Engine = new EngineOffsets
                    {
                        sv_cheats = 0x616A70,
                        mat_WireFrame = 0x5ADD61,
                        mat_fullbright = 0x121EF9,
                        mat_showlowresimage = 0x121EB1,
                        viewangles_x = 0x47C341,
                        viewangles_y = 0x47C33D,
                        r_shadowwireframe = 0x5D1769,
                        r_visualizetracers = 0x5AA411
                    },
                    Player = new PlayerOffsets
                    {
                        dwLocalPlayer = 0x4C88E8,
                        dwForceJump = 0x4F5D25,
                        crosshairID = 0x14F1,
                        m_fFlags = 0x351,
                        m_iTeamNum = 0x9D,
                        m_iHealth = 0x95,
